...
**O pacote glmnet também por padrão padroniza as variáveis (standardize=TRUE), o que é importante para a regressão Ridge e também para o LASSO. Ele posteriormente retorna os coeficientes para a escala inicial.**
